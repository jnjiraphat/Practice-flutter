...
class _StatefulHomePageState extends State<StatefulHomePage> {
  ...
  String _inputImg =
      "https://www.tcs-mart.com/web/wp-content/uploads/2018/02/sunflower-1627193_960_720-600x600.jpg";
  List<Content> contents = [];

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: Text('Flowers Page')),
      body: Column(
        children: <Widget>[
          Form(
            key: _formKey,
                ...
                RaisedButton(
                  onPressed: () {
                    ...
                    setState(() {
                      contents.insert(
                          0,
                          Content(_inputText, _inputDescript,
                              _inputImg)); //เพราะจะมาอยู่หน้าสุด
                    });
            ...
            child: contents.length == 0
                ...
                : ListView.builder(
                    ...
                    itemBuilder: (BuildContext context, int index) {
                      return FlowerCard(contents[index].text,
                          contents[index].description, contents[index].img);
                    }),
          )
        ],
      ),
...
class AnimalPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(title: Text('Animal Page')),
        body: Container(
          child: Text('Hi'),
        ));
  }
